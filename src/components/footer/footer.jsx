    ...
    <div className={styles.footer}>
      <div className={styles.footer__links}>
        ...
        <ul className={styles.footer__links__social}>
          ...
          <li>
            <Link href="https://www.tiktok.com/@une_taupe_chez_vous?lang=fr" title="TikTok" target="_blank" rel="noopener" prefetch={false}>
              <svg fill="#000000" width="16px" height="16px" viewBox="0 0 512 512" id="icons" xmlns="http://www.w3.org/2000/svg">
          ...
          <li>
            <Link href="https://www.youtube.com/@unetaupechezvous" title="YoutTube" target="_blank" rel="noopener" prefetch={false}>
              <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="16px" height="16px" viewBox="0 0 30 30">
          ...
          <li>
            <Link href="https://www.instagram.com/unetaupechezvous/" title="Instagram" target="_blank" rel="noopener" prefetch={false}>
              <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="16px" height="16px" viewBox="0 0 30 30">
